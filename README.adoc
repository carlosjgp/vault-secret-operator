# Vault sercret Operator image:https://travis-ci.org/carlosjgp/vault-secret-operator.svg?branch=master["Build Status", link="https://travis-ci.org/carlosjgp/vault-secret-operator"]
